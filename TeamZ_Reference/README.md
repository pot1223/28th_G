...
| --- | --- | --- | --- | --- | ---|
| 서비스 목적 |  안전 재난 알림 서비스 및 재난 대응 정보 제공 | 재난 문자 및 대응 정보 제공 |  전국 테러 예고 및 검거 정보 제공 | 재난 알림 및 대응 정보 제공  |  위치 기반 안전 지수 열람 기능 제공 |
| 핵심 제공 기능 |  재난 문자 요약 및 대처 방안 안내 <br> 재난 카테고리별 뉴스 <br> 현 위치 기반 대피소 지도 <br> 안전 상식 및 행동 요령 퀴즈 <br> 재난 카테고리별 펀딩/후원 기능  | 전국 재난 문자 열람 <br> 현 위치 기반 대피소 지도 <br> 국민 행동 요령 <br> 재난 뉴스 |  지도기반 테러 예고 <br> 검거 위치 정보 제공 <br> 테러 제보하기  |  재난속보 <br> 재난통계 <br> 시민 행동 요령 <br> 안전 편의 시설 정보| 지역별 안전지수 <br> 분야별 안전 지수 <br> 주변 안전 시설물 정보| 
...
| 알림 서비스 | 실시간 재난 문자를 활용한 추가적인 대응방법 제공 | O | X | O | X | 
...
| TAM | SAM | SOM |
| --- | --- | --- |
| 재난문자 수신하는 사람들 | 안전 알림 기능(재난 상황 발생 시 안전에 민감해지는 사람들) 안전에 대한 관심을가지고 적극적으로 정보를 찾아보는 사람 | 안전 알림 기능 + 후원 기능 (평소에도 안전과 관련한 정보 관심, 적극적으로 참여하려고 하는 사람)|
| 000만 명 | 000만 명 | 00만 명 |
...
|  | 안전 민감 성향 | 안전 불감 성향 |
| --- | --- | --- |
| 관련 기능 | 평상시에도 재난 대비 관련 퀴즈 컨텐츠 제공 <br> 카테고리별 뉴스 제공 <br> 정확한 관련 정보 제공 |  재난 발생 시 효과적인 대응 방안 및 관련 정보 제공  |
...
|  | 10~40대 | 50대 이상 |
| --- | --- | --- |
| 관련 기능 | 효과적인 재난 대응방안 제공 <br> 퀴즈 컨텐츠를 통한 정보 제공 <br> 뉴스 및 컨텐츠 공유 기능|  효과적인 재난 대응방안 제공 <br> 카테고리별 뉴스 제공 (SNS, 커뮤니티 등에서 정보를 빠르게 획득하는데 어려움을 겪는 타겟) <br> 글씨 크기 설정, 화면 확대 기능  |
